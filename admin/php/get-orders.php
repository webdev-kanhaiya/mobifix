	...
	if($_SERVER['REQUEST_METHOD']=="POST")
	{
		...
		if($result->num_rows>0)
		{
			...
			for($i=1;$i<=$result->num_rows;$i++)
			{
				...
				$orders.='<div class="order" order-id="'.$data["id"].'">
		...
		{
			$message="<div class='no-order-box'><img src='../images/no-orders.webp'><h3>There is No ".ucfirst($status)." Order</h3><p>Click on <i class='fa fa-plus-circle'></i> icon at the right bottom corner</p></div>";
